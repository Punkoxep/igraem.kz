...
export const ENV = {
  ...
  VAPID_PUBLIC_KEY: process.env.VAPID_PUBLIC_KEY || 'BL2wkTvGSQaq_XcVcKRCKL_XCnjF3_iwz-gePV4mBQoVXjgOWSYHmg-163mNj0hpgmOhuN5GHZYz2kPTjGdDWpg',
  VAPID_PRIVATE_KEY: process.env.VAPID_PRIVATE_KEY || 'V-oxfiBNAR-x2IOpzmr8gX_As6KQTGak3ESUPq4Pd_Q',
